              ...
              return (
                <div key={r.id} style={{ background: 'rgba(22,22,31,0.7)', border: '1px solid rgba(42,42,58,0.6)', borderRadius: '14px', padding: '16px 20px', display: 'flex', alignItems: 'center', gap: '14px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '6px', flexShrink: 0 }}>
                    ...
                    <button onClick={() => r.file_data && window.open(`data:${r.file_type};base64,${r.file_data}`, '_blank')} style={{ padding: '8px', background: 'rgba(99,102,241,0.1)', border: 'none', borderRadius: '8px', color: '#818cf8', cursor: 'pointer', display: 'flex' }} title="View">
                      <FileText size={16} />
                    </button>
                  </div>
                </div>
